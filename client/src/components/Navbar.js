  ...
  const drawer = (
    <Box onClick={handleDrawerToggle} sx={{ textAlign: "center" }}>
      ...
      <List>
        ...
        <ListItem className="listitem" disablePadding>
          <ListItemButton>
            <Link to="/tools" className="drawerlinks">
              {" "}
        ...
        {!loggedIn ? (
          <>
            <ListItem className="listitem" disablePadding>
              <ListItemButton>
                <Link to="/register" className="drawerlinks">
                  {" "}
            ...
            <ListItem className="listitem" disablePadding>
              <ListItemButton>
                <Link to="/login" className="drawerlinks">
                  {" "}
          ...
          <ListItem className="listitem" disablePadding>
            <ListItemButton>
              <Link to="/login" className="drawerlinks" onClick={handleLogout}>
                {" "}
        ...
        <Toolbar>
          ...
          <Box sx={{ display: { xs: "none", sm: "block" } }}>
            <Button sx={{ color: "white", fontSize: "15px" }}>
              ...
              {loggedIn ? (
                <Link className="navlinks" to="/login" onClick={handleLogout}>
                  Sign Out
                </Link>
              ) : (
                <>
