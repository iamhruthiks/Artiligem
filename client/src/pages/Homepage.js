                ...
                <Stack spacing={10} mb={8}>
                    <Item sx={{ p: 5, boxShadow: 24 }}>
                        ...
                        <Typography variant='h5' textAlign="left"
                            ...
                            <b>Powered by Google's Gemini API</b>, Artiligence delivers fast and accurate results.
                        </Typography>
                        <Button
                            color='success'
                            type='submit'
                            ...
                            onClick={() => window.open("https://github.com/iamhruthiks/Artiligence", "_blank")}
                        >
                            Visit GitHub
                        </Button>
                    </Item>
                    ...
                    <Item sx={{ p: 4, boxShadow: 24 }}>
                        ...
                        <Typography variant='h6' textAlign="left"
                            ...
                            <br /><br />
                            Join the AI revolution with <b>Artiligence</b> - the smart choice for your content creation needs.
                        </Typography>
                    </Item>
                </Stack>
                <div style={{ textAlign: "center", marginBottom: "0", fontFamily: "bold" }}>Copyrights &copy; 2024 Artiligence</div>
            </Box>
        </Box>
