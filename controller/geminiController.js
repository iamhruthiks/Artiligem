...
exports.chatController = async (req, res) => {
    try {
        const { text } = req.body
        const prompt = `Answer all my questions, similar to how mini would answer. Like me: 'whats your name'. mini:'my name is mini'. So always add "Mini:" before answersing.\n${text}`;
